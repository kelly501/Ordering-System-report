...
<header>
	...
	<div id="page_header">
		<div class="page_title">
			<h3>Login</h3>
			<ol class="breadcrumb"><li><a href="#">Home</a></li><li class="active">Menu</li></ol>
		</div>
	</div>
</header>
<!-- Aboutus page header -->
...
<section id="about_page" class="about_page text-center">
	<div class="container">
		...
		if (isset($_COOKIE["user"])){
			...
			echo '<input class="btn load_more" type="submit" value="Logout">';
			echo '</form>';
		} else {
		echo <<<LOGIN_FORM
		<form method="POST" action="login.php">
		User :  <input style="background-color:pink;border-radius:10px;border:2px black solid;" type="text" name="user"><br><br><br>
		Password : <input style="background-color:pink;border-radius:10px;border:2px black solid;"   type="password" name="pswd">
		<input class="btn load_more" type="submit" value="Login">
		</form>
