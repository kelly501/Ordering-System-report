...
<header>
	...
	<div id="page_header">
		<div class="page_title">
			<h3>Billboard</h3>
			<ol class="breadcrumb"><li><a href="#">Location</a></li><li class="active">Services</li></ol>
		</div>
	</div>
</header>
<!-- Aboutus page header -->
...
for ($i=1; $i<=ceil($rows/10); $i++){
	echo "<a href='billboard.php?p=".$i."'>".$i."</a>&nbsp;";
}
echo "<hr>";
...
echo'<table width="900" height="300" border="5" align="center" style="border:5px pink dashed;background-color:white;" cellpadding="20">
　<tr>
  <td align="center"  height="60" ><strong><font size="5"><font color="#FF4545">Rank  /  排名</strong></td>
　<td align="center"  height="60" ><strong><font size="5"><font color="#FF4545">Item  /  項目</strong></td>
　<td align="center"  height="60" ><strong><font size="5"><font color="#FF4545">Number  /  累積量</strong></td>
  </tr>';
$i=1;
while ($row = mysql_fetch_row($result)){
echo'<tr>';
echo'<td width="300" height="50" align="center" >';
echo 'No.'.($i+($p-1)*10);
$i++;
echo'</td>';
echo'<td width="300" height="50" align="center" >';
...
echo "<a href='billboard.php?p=1'>";
echo "<img src='jp".$p.".php'>";
echo "</a>";
echo'</div>';
