...
<header>
	...
	<div id="page_header">
		<div class="page_title">
			<h3>Menu</h3>
			<ol class="breadcrumb"><li><a href="#">Login</a></li><li class="active">Shopping Cart</li></ol>
		</div>
	</div>
</header>
<!-- Aboutus page header -->
...
<form method='POST' action='order_2.php'>
<table id="item">
<?php
  $im=array("item/image/01.jpg","item/image/02.jpg","item/image/03.jpg","item/image/04.jpg","item/image/05.jpg","item/image/06.jpg","item/image/07.jpg","item/image/08.jpg","item/image/09.jpg","item/image/10.jpg","item/image/11.jpg","item/image/12.jpg","item/image/13.jpg","item/image/14.jpg","item/image/15.jpg","item/image/16.jpg","item/image/17.jpg","item/image/18.jpg","item/image/19.jpg","item/image/20.jpg","item/image/21.jpg","item/image/22.jpg","item/image/23.jpg","item/image/24.jpg","item/image/25.jpg","item/image/26.jpg","item/image/27.jpg","item/image/28.jpg","item/image/29.jpg","item/image/30.jpg","item/image/31.jpg","item/image/32.jpg","item/image/33.jpg","item/image/34.jpg","item/image/35.jpg","item/image/36.jpg","item/image/37.jpg","item/image/38.jpg","item/image/39.jpg","item/image/40.jpg","item/image/41.jpg","item/image/42.jpg","item/image/43.jpg","item/image/44.jpg","item/image/45.jpg","item/image/46.jpg","item/image/47.jpg","item/image/48.jpg","item/image/49.jpg","item/image/50.jpg");
  $in=array("竹姬壽司青森扇貝","玉子燒天婦羅","奶油乳酪鮭魚","奶油乳酪鮮蝦","酪梨長鰭鮪魚","七味粉醃漬生鮮蝦","槍烏賊","青森扇貝","北寄貝","厚切燒炙鰹魚","蒲燒鮭魚(一貫)","竹姬壽司鮮蝦沙拉","柚香稻荷壽司","七味粉醃漬鮪魚","香煎芝麻扇貝","炙烤照燒豬","竹姬壽司海鮮海膽","竹姬壽司鹽味半熟蛋鮪魚","熟成鮪魚","特選長鰭鮪魚","黑胡椒燒霜鮪魚","生鮭魚(一貫)","鮭魚肚","燒炙鮭魚肚","洋蔥鮭魚","炙烤照燒鮭魚","炙烤起司鮭魚","炙烤蒜香鮭魚","炙烤照燒鮮蝦","炙烤起司鮮蝦","炙烤蒜香豬","柚子胡椒醃漬長鰭鮪魚","究極蟹肉棒","甜蝦","鮮蝦","大生鮮蝦(一貫)","酪梨鮮蝦","稻荷壽司","玉子燒","烤鯖魚押壽司","蒲燒鰻魚(一貫)","星鰻","鰈魚緣側","厚切鯖魚","香烤鯖魚","秋刀魚","花枝","北海道大帆立貝","豬肉鹽味蔥花","松葉蟹(一貫)");
  $ip=array("40","40","40","40","40","40","40","40","40","80","40","40","40","40","40","40","40","40","40","80","40","40","40","$40 元","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","40","80","40","80");
  $count=count($in);
...
echo "<table>";
  for($i=0;$i<$count;$i++){
	...
	echo "$$ip[$i]元";
	echo "</div>";
	echo "<input type='hidden' name='in01[$i]' value='".$in[$i]."'>";
	echo "<input type='hidden' name='ip01[$i]' value='".$ip[$i]."'>";
	echo "<div>";
  	echo "<input type='number' name='nb01[$i]' min='0' max=''  step='1' value='0' >";
  	echo "</div>";
  	echo "</td>";
    if($i%4 == 3){
  		echo "</tr>";
...
?>
<br><br>
<input style="width:120px;height:30px; background-color:pink;border-radius:10px;border:2px #FFB6C1 solid;" type='submit' name='do' value='order'>
<input style="width:120px;height:30px; background-color:pink;border-radius:10px;border:2px #FFB6C1 solid;" type="button" value="view purchases" onclick="location.href='order.php?p=1'">
</form>
</div>
</section>
