...
<input style="width:120px;height:30px;margin:3px; background-color:pink;border-radius:10px;border:2px #FFB6C1 solid;" type="submit" name="del"  value="delete">
<input style="width:120px;height:30px;margin:3px; background-color:pink;border-radius:10px;border:2px #FFB6C1 solid;" type="button" value="menu" onclick="location.href='menu.php'">
<input style="width:120px;height:30px;margin:3px; background-color:pink;border-radius:10px;border:2px #FFB6C1 solid;" type="button" value="purchase" onclick="location.href='shopping_cart.php'">
