		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav text-center">
					...
					<li><a href="login2.php">Shopping Cart</a></li>
...
<section id="about_page" class="about_page text-center">
	<div class="container">
		...
		$sql = "SELECT * FROM members where user='".$user."' and pswd='".$pswd."' and reply='Y'";
		...
		if ($nums>0){
			...
			echo <<<LOGIN_FORM
			Login fail! <br><br>
			'User' or 'Password' error . <br><br>
        	<form method="POST" action="login2.php">
			<input class="btn load_more" type="submit" value="Restart">
			</form>
LOGIN_FORM;
		}
