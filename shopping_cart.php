...
<header>
	...
	<div id="page_header">
		<div class="page_title">
			<h3>Shopping Cart</h3>
			<ol class="breadcrumb"><li><a href="#">Menu</a></li><li class="active">Location</li></ol>
		</div>
	</div>
</header>
<!-- Aboutus page header -->
			...
			<body>  
                	...
                	<div class="col-md-12" align="right">
                     <form method="post" action="shopping.php">
                     	<div style="text-align: center">You can see your menu to click the button. </div>
                     		 
                          <input class="btn load_more" type="submit" name="generate_pdf" value="Generate PDF" >
                     </form>  
